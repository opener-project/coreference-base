...
quantifiers = list_checker(("niet", "iedere", "ieder", "geen", "alle", "alles", "niets", "voldoende", "genoeg", "enkele", "enige", "sommige", "elk", "elke", "heleboel", "menig", "menige", "niks"))
...
partitives = list_checker(("half", "halve", "een", "twee", "drie", "vier", "vijf", "zes", "zeven", "acht", "negen", "tien" , "honderd","duizend", "miljoen", "biljoen", "tientallen",  "honderden", "duizenden", "miljoenen", "biljoenen","groep", "groepen", "aantal", "aantallen", "hoeveelheid", "hoeveelheden", "totaal", "alle", "pond", "kilo", "meter","kilometer", "kilometers", "ponden", "kilo's",  "stapels")) 
