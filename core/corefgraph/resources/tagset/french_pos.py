...
#Adecjtives
adjectives = list_checker((_adjective,))
...
# Enumerations
enumerable_mention_words = list_checker((_proper_noun,_proper_noun))

conjunction = equality_checker(_conjunctions)
interjections = equality_checker(_interjection)
#cardinal = equality_checker("CD")
wh_words = list_checker((_wh_pronoun, _wh_possessive_pronoun))
