...
class GraphWrapper():
    ...
    @classmethod
    def get_vertex_by_id(cls, graph, id):
        return find_vertex(graph, graph.vertex_properties['id'], id)[0]
    ...
    @classmethod
    def get_all_vertex_by_property(cls, graph, property, value):
        return find_vertex(graph, graph.vertex_properties[property], value)
